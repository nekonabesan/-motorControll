...
class SetModes():
    ...
    # echo "GYRO-G&A" > /sys/class/lego-sensor/sensor2/mode && cat /sys/class/lego-sensor/sensor2/mode
    # echo "GYRO-ANG" > /sys/class/lego-sensor/sensor2/mode && cat /sys/class/lego-sensor/sensor2/mode
